...
class ProposalTargetLayer(caffe.Layer):
    ...
    def forward(self, bottom, top):
        ...
        # targets
        labels, rois, bbox_targets, bbox_inside_weights,mask_targets,rois_layers = _sample_rois(
...
def _sample_rois(all_rois, gt_boxes,gt_masks,fg_rois_per_image, rois_per_image, num_classes,image_data):
    ...
    return permuted_lables, permuted_rois, bbox_targets, bbox_inside_weights, permuted_mask_targets,rois_layers
